...
public class GetPromoPostsCountIntegrationTests {
    @Autowired
    private MockMvc mockMvc;
    private UsuarioRepository userRepository = new UsuarioRepository();
    private PostRepository postRepository = new PostRepository();

    public GetPromoPostsCountIntegrationTests() throws JsonProcessingException {
        restoreUsersFile();
        emptyPostsFile();
    }
    ...
    @Test
    public void getPromoPostsCountOfValidUser() throws Exception {
        fail("TODO");
    }

    @Test
    public void getPromoPostsCountOfInvalidUserAndThrow() throws Exception {
        MockHttpServletRequestBuilder getPromoPostsCountOfInvalidUser = MockMvcRequestBuilders
                .get("/products/{userId}/promo-post/count", 123);

        this.mockMvc.perform(getPromoPostsCountOfInvalidUser)
                .andDo(print())
