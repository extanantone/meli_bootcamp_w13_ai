...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity<ResponseDTO> MethodArgumentNotValidException(MethodArgumentNotValidException e) {
        ResponseDTO error = new ResponseDTO("MethodArgumentNotValidException: " + e.getBindingResult().getFieldError().getDefaultMessage());
