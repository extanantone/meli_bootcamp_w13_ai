...
public class PostController {
    ...
    //US_0005
    @PostMapping("/post")
    public ResponseEntity<ResponseDTO> altaPublicacion (@Valid @RequestBody PostShortDTO publicacion){
    ...
    public ResponseEntity<ResponseDTO> altaPublicacionPromocion (@Valid @RequestBody PostFullDTO publicacionFull){
