...
public class PublicacionService implements IPublicacionService {
    ...
    @Override
    public PublicacionFollowedDTO listaPublicacionesFollowed(Integer userId, String order) {
        ...
        if (order.equals("date_asc")) {
            ...
            listaPublicacionDTO = listaPublicacionDTO
                    .stream()
                    .sorted(Comparator.comparing(PublicacionDTO::getDate).reversed())
                    .collect(Collectors.toList());
        }
