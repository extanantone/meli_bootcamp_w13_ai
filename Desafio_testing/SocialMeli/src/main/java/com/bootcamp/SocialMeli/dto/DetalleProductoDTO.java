...
public class DetalleProductoDTO {
    ...
    @Pattern(regexp = "^[a-zA-Z0-9ñáéíóúüÁÉÍÓÚ ]*$", message = "El campo product_name no puede poseer caracteres especiales.")
    private String productName;

    @NotBlank(message = "El campo type no puede estar vacío.")
    @Size(max = 15, message = "La longitud no puede superar los 15 caracteres.")
    @Pattern(regexp = "^[a-zA-Z0-9ñáéíóúüÁÉÍÓÚ ]*$", message = "El campo type no puede poseer caracteres especiales.")
    private String type;

    @NotBlank(message = "El campo brand no puede estar vacío.")
    @Size(max = 25, message = "La longitud no puede superar los 25 caracteres.")
    @Pattern(regexp = "^[a-zA-Z0-9ñáéíóúüÁÉÍÓÚ ]*$", message = "El campo brand no puede poseer caracteres especiales.")
    private String brand;

    @NotBlank(message = "El campo color no puede estar vacío.")
    @Size(max = 15, message = "La longitud no puede superar los 15 caracteres.")
    @Pattern(regexp = "^[a-zA-Z0-9ñáéíóúüÁÉÍÓÚ ]*$", message = "El campo color no puede poseer caracteres especiales.")
