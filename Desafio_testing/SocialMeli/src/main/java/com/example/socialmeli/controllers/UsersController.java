...
public class UsersController {
    ...
    public CountFollowersResponseDTO countFollowers(@PathVariable Integer userId)
    ...
    public FollowersResponseDTO getFollowers(@PathVariable Integer userId,
    ...
    public FollowedResponseDTO getFollowed(@PathVariable Integer userId,
                                           @RequestParam @Nullable String order)
            throws UserNotFoundException {
