...
public class SocialMeliSeviceImpl implements ISocialMeliService {
    ...
    public void createNewPublicacion(PublicacionDTO publicacionDTO) {
       ...
       // LocalDate fecha = LocalDate.parse(publicacionDTO.getDate(), DateTimeFormatter.ofPattern("dd-MM-yyyy"));
        ...
        repositorio.newPost(publicacionDTO.getUserId(), new Publicacion(publicacionDTO.getIdPost(), publicacionDTO.getCategory(), publicacionDTO.getPrice(),publicacionDTO.getDate() , pro, publicacionDTO.getHasPromo() != null ? publicacionDTO.getHasPromo() : false, publicacionDTO.getDiscount()));
