...
public class ControllerSocialMeli {
    ...
    public ResponseEntity<?> newPost(@Valid  @RequestBody DTOproductsRequest product){
        serviceProduct.createProduct(product);
        return new ResponseEntity<>(new DTOEmptyJsonResponse(), HttpStatus.OK) ;
    }

    @PostMapping("/products/promo-post")
    public ResponseEntity<?> newPostPromo(@Valid @RequestBody DTOproductsRequest product){
