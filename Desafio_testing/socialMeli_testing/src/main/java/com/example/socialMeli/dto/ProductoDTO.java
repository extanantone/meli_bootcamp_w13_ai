...
public class ProductoDTO {
    ...
    @Pattern(regexp = "^[A-Z|À-Ù|Á-Ú|Ä-Ü|á-ú|ä-ü|a-z|à-ù|0-9|,|.| ]*$", message = "El nombre del produc no puede poseer caracteres especiales")    private String product_name;
    ...
    @Pattern(regexp = "^[A-Z|À-Ù|Á-Ú|Ä-Ü|á-ú|ä-ü|a-z|à-ù|0-9|,|.| ]*$", message = "El tipo no puede poseer caracteres especiales")    private String type;
    ...
    @Pattern(regexp = "^[A-Z|À-Ù|Á-Ú|Ä-Ü|á-ú|ä-ü|a-z|à-ù|0-9|,|.| ]*$", message = "La marca no puede poseer caracteres especiales")    private String brand;
    ...
    @Pattern(regexp = "^[A-Z|À-Ù|Á-Ú|Ä-Ü|á-ú|ä-ü|a-z|à-ù|0-9|,|.| ]*$", message = "El color no puede poseer caracteres especiales")    private String color;
    @NotNull(message = "Debe añadir notas")
    @Size(max=80, message = "Las notas no pueden tener una longitud mayor a ochenta")
