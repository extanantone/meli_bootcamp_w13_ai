public class Participante {
    ...
    public String toString() {
        return String.format("Inscrito # %d -> DNI: %d - Nombre: %s %s - edad: %d - celular: %d - numero de emergencia: %d" +
                " - grupo sanguineo: %s", numParticipante, dni, nombre, apellido, edad, celular, nroEmergencia, grupoSanguineo);
    }
}