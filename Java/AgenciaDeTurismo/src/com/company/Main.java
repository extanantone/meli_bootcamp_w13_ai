...
// el cual consiste en reservas de hotel, comida, boletos de viajes y transporte.
// Las reservas son almacenadas en localizadores, los cuales contienen los datos del cliente,
// el total y la reserva o varias reservas dependiendo del producto adquirido.
...
//Al momento de generar el localizador se debe almacenar en una clase repositorio y se imprimirá el mismo
// con los detalles de la compra.

//Se requiere crear un repositorio cliente, para así poder buscar las reservas anteriores del cliente
// y aplicar descuentos; en caso de no existir el cliente poder agregarlo al repositorio cliente.
//
//Parte I
