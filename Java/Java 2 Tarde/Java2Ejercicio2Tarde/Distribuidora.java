...
public class Distribuidora {
    public static void main(String[] args) {
        ...
        Producto perecedero4 = new Perecedero("Yogurt", 130.40, 1);
        Producto perecedero5 = new Perecedero("Pescado", 220.80, 3);

        Producto noPerecedero1 = new NoPerecedero("Detergente", 98.60, "Limpieza");
        Producto noPerecedero2 = new NoPerecedero("Arroz", 115.40, "Almacen");
        Producto noPerecedero3 = new NoPerecedero("Fideos", 48.20, "Almacen");
        Producto noPerecedero4 = new NoPerecedero("Chocolate", 125.60, "Golosina");
        Producto noPerecedero5 = new NoPerecedero("Sal", 57.60, "Almacen");
