...
public class Person {
    ...
    public Person(int dni, String nombre, String apellido, int edad, long celular, long numero_de_emergencia, String grupo_sanguineo,int inscripcion,int saldo) {
        this.dni = dni;
        this.nombre = nombre;
    ...
    public String toString() {
        return "Person{" +
                ...
                ", edad=" + edad +
                ", celular=" + celular +
                ", numero_de_emergencia=" + numero_de_emergencia +
