...
select nombre as nombre_estudiante 
from Estudiante where nombre like 'G%';
...
where 
    ...
    and au.idAutor = a.idAutor and l.idLibro=a.idLibro;
...
select l.*
from 
	Libro l inner join Prestamo p on l.idLibro=p.idLibro 
...
from Libro l, LibroAutor a, Autor au 
where 
		au.nombre = 'J.K. Rowling' 
		and au.idAutor = a.idAutor 
        and l.idLibro=a.idLibro;
