...
public class UserController {
    ...
    ResponseEntity<?> listFollowers(@PathVariable("userId") int user_id,@RequestParam(required = false) String order){
    ...
    ResponseEntity<?> listFollowed(@PathVariable("userId") int user_id,@RequestParam(required = false) String order){
