...
// geenramos nuestra base de datos de usuario/vendedorres
 ...
 //metodo para encontrar un usario que sigue a un vendedor
  ...
  //genero un metodo que recibira como parametro el id y retornara mi lista de usuario con el id que le ingreso e indicando
    //la cantidad de seguidores que tienen ese vendedor(id) con el metodo size().
    public int CountFollowers(int userId){
        return mapUser.get(userId).getFollowers().size();
