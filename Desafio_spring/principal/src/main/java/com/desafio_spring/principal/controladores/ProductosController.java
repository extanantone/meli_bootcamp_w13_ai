...
public class ProductosController {
    ...
    @PostMapping("/post")
    public ResponseEntity<Object> crearPost(@RequestBody PublicacionesDTO entrada){
        serv.crearPublicacion(entrada);
        return ResponseEntity.status(HttpStatus.OK).build();
    }

    @PostMapping("/promo-post")
    public ResponseEntity<Object> crearPostPromo(@RequestBody PublicacionesDTO entrada){
