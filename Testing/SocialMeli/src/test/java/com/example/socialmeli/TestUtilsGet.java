...
public class TestUtilsGet {
    ...
    public static User getTheo() {
        User manuel = new User();
        manuel.setUserId(1);
        manuel.setUserName("Theo");
        manuel.setFollowersId(Collections.emptyList());
        return manuel;
    }

    public static User getAmbar() {
        User azul = new User();
        azul.setUserId(2);
        azul.setUserName("Ambar");
        azul.setFollowersId(Collections.emptyList());
        return azul;
    }

    public static User getGonzalo() {
        User fede = new User();
        fede.setUserId(3);
        fede.setUserName("Gonzalo");
        fede.setFollowersId(Collections.emptyList());
        return fede;
    }

    public static List<User> getUnsortedUserList() {
        return List.of(getTheo(), getAmbar(), getGonzalo());
    }
