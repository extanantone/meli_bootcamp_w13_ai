public class EjercicioTemperaturas {
    public static void main(String[] args) {
        ...
        System.out.println("La ciudad con mayor temperatura es: " + ciudad_max + ", con una temperatura de: " + max);
        System.out.println("La ciudad con menor temperatura es: " + ciudad_min + ", con una temperatura de: " + min);
